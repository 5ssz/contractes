...
document.addEventListener('DOMContentLoaded', () => {
    ...
    document.getElementById('resetHorarios').addEventListener('click', resetGame);
});
...
function loadPairs() {
    pairs = [
        {
            concept: "Jornada Continuada",
            definition: "Sense pausa significativa, excepte petites pauses de descans."
        },
        {
            concept: "Jornada Partida",
            definition: "Amb pausa d'almenys 1 hora, dividint la jornada en dues parts."
        },
        {
            concept: "Horari Flexible",
            definition: "Inici i final ajustables dins un marge acordat, respectant hores totals."
        },
        {
            concept: "Torn Rotatiu",
            definition: "Alternança de torns (matí, tarda, nit) segons cicles preestablerts."
        },
        {
            concept: "Descans Diari",
            definition: "12 hores consecutives entre el final d'una jornada i l'inici de la següent."
        },
        {
            concept: "Descans Setmanal",
            definition: "Mínim 1 dia i mig ininterromput (36 hores)."
        },
        {
            concept: "Hores Extraordinàries",
            definition: "Treball efectuat fora de la jornada ordinària amb límit de 80 hores anuals."
        },
        {
            concept: "Treball Nocturn",
            definition: "Realitzat entre les 22:00 i les 6:00 hores amb retribució específica."
        }
    ];
...
function showSuccessMessage() {
    const gameSection = document.querySelector('.horarios-game-section');
